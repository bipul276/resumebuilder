...
export function createEmptyResume(): ResumeData {
    ...
    return {
        ...
        personalInfo: {
            ...
            phone: '+911234567890',
            location: 'State',
            linkedIn: 'yourlinkden.com',
            github: 'yourgithub.com',
            portfolio: 'yourportfolio.com',
            title: 'MERN FULL STACK\nWEB DEVELOPER',
        },
        summary: 'A 400 character professional summary about you that helps recruiters to know and understanding your fit for their company.',
        workExperience: [],
        education: [
            {
                id: generateId(),
                institution: 'Institute',
                degree: 'Your Degree in Computer Science',
                field: '',
                startDate: '',
                endDate: 'Jan 2000',
                location: '',
        ...
        skills: [
            { id: generateId(), name: 'JavaScript', category: 'Default', level: 0, order: 0 },
            { id: generateId(), name: 'Node', category: 'Default', level: 0, order: 1 },
            { id: generateId(), name: 'Express', category: 'Default', level: 0, order: 2 },
            { id: generateId(), name: 'Git', category: 'Default', level: 0, order: 3 },
            { id: generateId(), name: 'Github', category: 'Default', level: 0, order: 4 },
            { id: generateId(), name: 'Docker', category: 'Default', level: 0, order: 5 },
            { id: generateId(), name: 'Kubernets', category: 'Default', level: 0, order: 6 },
            { id: generateId(), name: 'Linux', category: 'Default', level: 0, order: 7 },
        ],
        projects: [
            {
                id: generateId(),
                name: 'Project 1',
                description: 'A python project that focuses on a ai tool to guide elderly in there day to day lives.',
                url: '',
                githubUrl: '',
                liveUrl: '',
                technologies: [],
            ...
            },
            {
                id: generateId(),
                name: 'Project 2',
                description: 'A IOT project that creates a sensory modal that stops crashes from happening and makes it 0.',
                url: '',
                githubUrl: '',
                liveUrl: '',
                technologies: [],
