...
export function renderMinimalTemplate(data: ResumeData): string {
  ...
  const renderSection = (section: SectionType): string => {
    ...
    ${workExperience.sort((a: any, b: any) => a.order - b.order).map((j: WorkExperience) => `<div class="entry"><div class="entry-header"><span><span class="entry-title">${escapeHtml(j.position)}</span> <span class="entry-company">at ${escapeHtml(j.company)}</span></span><span class="entry-date">${formatDate(j.startDate)} – ${j.isCurrentRole ? 'Present' : formatDate(j.endDate)}</span></div>${j.bullets.filter((b: string) => b.trim()).length > 0 ? `<ul class="bullets">${j.bullets.filter((b: string) => b.trim()).map((b: string) => `<li>${parseMarkdownLinks(escapeHtml(b))}</li>`).join('')}</ul>` : ''}</div>`).join('')}</div>` : '';
      case 'education': return education.length > 0 ? `<div class="section"><div class="section-title">Education</div>
    ${education.sort((a: any, b: any) => a.order - b.order).map((e: Education) => `<div class="entry"><div class="entry-header"><span class="entry-title">${escapeHtml(e.degree)}${e.field ? ` in ${escapeHtml(e.field)}` : ''}</span><span class="entry-date">${formatDate(e.endDate)}</span></div><div class="entry-company">${escapeHtml(e.institution)}</div></div>`).join('')}</div>` : '';
    ...
    ${projects.sort((a: any, b: any) => a.order - b.order).map((p: Project) => `<div class="entry"><span class="entry-title">${p.url && !p.githubUrl && !p.liveUrl ? `<a href="${escapeHtml(p.url)}" target="_blank" style="color:inherit;text-decoration:none">${escapeHtml(p.name)}</a>` : escapeHtml(p.name)}</span>${(p.githubUrl || p.liveUrl) ? `<span style="font-size: 0.9em; margin-left: 8px;">${p.githubUrl ? `<a href="${escapeHtml(p.githubUrl)}" target="_blank" style="color: #4f46e5; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.githubUrl.replace(/^https?:\/\//, '')) : 'GitHub'}</a>` : ''}${p.githubUrl && p.liveUrl ? `<span style="color: #ccc; margin: 0 4px;">|</span>` : ''}${p.liveUrl ? `<a href="${escapeHtml(p.liveUrl)}" target="_blank" style="color: #4f46e5; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.liveUrl.replace(/^https?:\/\//, '')) : 'Live Demo'}</a>` : ''}</span>` : ''}${p.description ? `<p style="color:#555;margin-top:4px">${formatDescription(p.description)}</p>` : ''}</div>`).join('')}</div>` : '';
...
export function renderExecutiveTemplate(data: ResumeData): string {
  ...
  const renderSection = (section: SectionType): string => {
    ...
    ${workExperience.sort((a: any, b: any) => a.order - b.order).map((j: WorkExperience) => `<div class="entry"><div class="entry-header"><div><span class="entry-title">${escapeHtml(j.position)}</span><br><span class="entry-company">${escapeHtml(j.company)}${j.location ? `, ${escapeHtml(j.location)}` : ''}</span></div><span class="entry-date">${formatDate(j.startDate)} – ${j.isCurrentRole ? 'Present' : formatDate(j.endDate)}</span></div>${j.bullets.filter((b: string) => b.trim()).length > 0 ? `<ul class="bullets">${j.bullets.filter((b: string) => b.trim()).map((b: string) => `<li>${parseMarkdownLinks(escapeHtml(b))}</li>`).join('')}</ul>` : ''}</div>`).join('')}</div>` : '';
      case 'education': return education.length > 0 ? `<div class="section"><div class="section-title">Education</div>
    ${education.sort((a: any, b: any) => a.order - b.order).map((e: Education) => `<div class="entry"><div class="entry-header"><span class="entry-title">${escapeHtml(e.degree)}${e.field ? ` in ${escapeHtml(e.field)}` : ''}</span><span class="entry-date">${formatDate(e.endDate)}</span></div><div class="entry-company">${escapeHtml(e.institution)}</div></div>`).join('')}</div>` : '';
    ...
    ${projects.sort((a: any, b: any) => a.order - b.order).map((p: Project) => `<div class="entry"><span class="entry-title">${p.url && !p.githubUrl && !p.liveUrl ? `<a href="${escapeHtml(p.url)}" target="_blank" style="color:inherit;text-decoration:none">${escapeHtml(p.name)}</a>` : escapeHtml(p.name)}</span>${(p.githubUrl || p.liveUrl) ? `<span style="font-size: 0.9em; margin-left: 8px; font-family: sans-serif;">${p.githubUrl ? `<a href="${escapeHtml(p.githubUrl)}" target="_blank" style="color: #1a365d; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.githubUrl.replace(/^https?:\/\//, '')) : 'GitHub'}</a>` : ''}${p.githubUrl && p.liveUrl ? `<span style="color: #cbd5e0; margin: 0 4px;">|</span>` : ''}${p.liveUrl ? `<a href="${escapeHtml(p.liveUrl)}" target="_blank" style="color: #1a365d; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.liveUrl.replace(/^https?:\/\//, '')) : 'Live Demo'}</a>` : ''}</span>` : ''}${p.description ? `<p style="color:#4a5568;margin-top:4px">${formatDescription(p.description)}</p>` : ''}</div>`).join('')}</div>` : '';
      case 'certifications': return renderCertificationsHtml(data);
      default:
        if (typeof section === 'string' && section.startsWith('custom_')) return renderCustomSectionHtml(data, section);
        return '';
...
export function renderCreativeTemplate(data: ResumeData): string {
  ...
  const renderSection = (section: SectionType): string => {
    switch (section) {
      ...
      case 'workExperience': return workExperience.length > 0 ? `<div class="section"><div class="section-title">Experience</div>
        ${workExperience.sort((a: any, b: any) => a.order - b.order).map((j: WorkExperience) => `<div class="entry"><div class="entry-title">${escapeHtml(j.position)}</div><div class="entry-meta">${escapeHtml(j.company)} · ${formatDate(j.startDate)} – ${j.isCurrentRole ? 'Present' : formatDate(j.endDate)}</div>${j.bullets.filter((b: string) => b.trim()).length > 0 ? `<ul class="bullets">${j.bullets.filter((b: string) => b.trim()).map((b: string) => `<li>${parseMarkdownLinks(escapeHtml(b))}</li>`).join('')}</ul>` : ''}</div>`).join('')}</div>` : '';
      case 'education': return education.length > 0 ? `<div class="section"><div class="section-title">Education</div>
        ${education.sort((a: any, b: any) => a.order - b.order).map((e: Education) => `<div class="entry"><div class="entry-title">${escapeHtml(e.degree)}${e.field ? ` in ${escapeHtml(e.field)}` : ''}</div><div class="entry-meta">${escapeHtml(e.institution)} · ${formatDate(e.endDate)}</div></div>`).join('')}</div>` : '';
      case 'skills': return ''; // Skills are in the sidebar
      case 'projects': return projects.length > 0 ? `<div class="section"><div class="section-title">Projects</div>
         ${projects.sort((a: any, b: any) => a.order - b.order).map((p: Project) => `<div class="entry"><div class="entry-title">${p.url && !p.githubUrl && !p.liveUrl ? `<a href="${escapeHtml(p.url)}" target="_blank" style="color:inherit;text-decoration:none">${escapeHtml(p.name)}</a>` : escapeHtml(p.name)}${(p.githubUrl || p.liveUrl) ? `<span style="font-size: 0.85em; margin-left: 8px; font-weight: normal;">${p.githubUrl ? `<a href="${escapeHtml(p.githubUrl)}" target="_blank" style="color: var(--accent); text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.githubUrl.replace(/^https?:\/\//, '')) : 'GitHub'}</a>` : ''}${p.githubUrl && p.liveUrl ? `<span style="color: #d1d5db; margin: 0 4px;">|</span>` : ''}${p.liveUrl ? `<a href="${escapeHtml(p.liveUrl)}" target="_blank" style="color: var(--accent); text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.liveUrl.replace(/^https?:\/\//, '')) : 'Live Demo'}</a>` : ''}</span>` : ''}</div>${p.description ? `<p style="font-size:10pt;color:#4b5563">${formatDescription(p.description)}</p>` : ''}</div>`).join('')}</div>` : '';
      case 'certifications': return renderCertificationsHtml(data);
      default:
        if (typeof section === 'string' && section.startsWith('custom_')) return renderCustomSectionHtml(data, section);
        return '';
...
export function renderCompactTemplate(data: ResumeData): string {
  ...
  const renderSection = (section: SectionType): string => {
    switch (section) {
      ...
      case 'workExperience': return workExperience.length > 0 ? `<div class="section"><div class="section-title">Experience</div>
    ${workExperience.sort((a: any, b: any) => a.order - b.order).map((j: WorkExperience) => `<div class="entry"><div class="entry-header"><span><span class="entry-title">${escapeHtml(j.position)}</span> - <span class="entry-company">${escapeHtml(j.company)}</span></span><span class="entry-date">${formatDate(j.startDate)}-${j.isCurrentRole ? 'Present' : formatDate(j.endDate)}</span></div>${j.bullets.filter((b: string) => b.trim()).length > 0 ? `<ul class="bullets">${j.bullets.filter((b: string) => b.trim()).map((b: string) => `<li>${parseMarkdownLinks(escapeHtml(b))}</li>`).join('')}</ul>` : ''}</div>`).join('')}</div>` : '';
      case 'education': return education.length > 0 ? `<div class="section"><div class="section-title">Education</div>
    ${education.sort((a: any, b: any) => a.order - b.order).map((e: Education) => `<div class="entry"><div class="entry-title">${escapeHtml(e.degree)}</div><div class="entry-company">${escapeHtml(e.institution)} · ${formatDate(e.endDate)}</div></div>`).join('')}</div>` : '';
      ...
      case 'projects': return projects.length > 0 ? `<div class="section"><div class="section-title">Projects</div>
    ${projects.sort((a: any, b: any) => a.order - b.order).slice(0, 3).map((p: Project) => `<div class="entry"><span class="entry-title">${p.url && !p.githubUrl && !p.liveUrl ? `<a href="${escapeHtml(p.url)}" target="_blank" style="color:inherit;text-decoration:none">${escapeHtml(p.name)}</a>` : escapeHtml(p.name)}</span>${(p.githubUrl || p.liveUrl) ? `<span style="font-size: 0.9em; margin-left: 8px;">${p.githubUrl ? `<a href="${escapeHtml(p.githubUrl)}" target="_blank" style="color: #000; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.githubUrl.replace(/^https?:\/\//, '')) : 'GitHub'}</a>` : ''}${p.githubUrl && p.liveUrl ? `<span style="color: #e5e7eb; margin: 0 4px;">|</span>` : ''}${p.liveUrl ? `<a href="${escapeHtml(p.liveUrl)}" target="_blank" style="color: #000; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.liveUrl.replace(/^https?:\/\//, '')) : 'Live Demo'}</a>` : ''}</span>` : ''} - ${formatDescription(p.description) || ''}</div>`).join('')}</div>` : '';
      case 'certifications': return renderCertificationsHtml(data);
      default:
        if (typeof section === 'string' && section.startsWith('custom_')) return renderCustomSectionHtml(data, section);
        return '';
...
export function renderProfessionalTemplate(data: ResumeData): string {
  ...
  const renderSection = (section: SectionType): string => {
    ...
    ${workExperience.sort((a: any, b: any) => a.order - b.order).map((j: WorkExperience) => `<div class="entry"><div class="entry-header"><div><span class="entry-title">${escapeHtml(j.position)}</span><br><span class="entry-company">${escapeHtml(j.company)}</span></div><span class="entry-date">${formatDate(j.startDate)} - ${j.isCurrentRole ? 'Present' : formatDate(j.endDate)}</span></div>${j.bullets.filter((b: string) => b.trim()).length > 0 ? `<ul class="bullets">${j.bullets.filter((b: string) => b.trim()).map((b: string) => `<li>${parseMarkdownLinks(escapeHtml(b))}</li>`).join('')}</ul>` : ''}</div>`).join('')}</div>` : '';
      case 'education': return education.length > 0 ? `<div class="section"><div class="section-title">Education</div>
    ${education.sort((a: any, b: any) => a.order - b.order).map((e: Education) => `<div class="entry"><div class="entry-header"><span class="entry-title">${escapeHtml(e.degree)}${e.field ? ` - ${escapeHtml(e.field)}` : ''}</span><span class="entry-date">${formatDate(e.endDate)}</span></div><div class="entry-company">${escapeHtml(e.institution)}</div></div>`).join('')}</div>` : '';
      case 'skills': return skills.length > 0 ? `<div class="section"><div class="section-title">Skills</div><div class="skills">${skills.map((s: Skill) => `<span class="skill">${escapeHtml(s.name)}</span>`).join('')}</div></div>` : '';
      case 'projects': return projects.length > 0 ? `<div class="section"><div class="section-title">Projects</div>
    ${projects.sort((a: any, b: any) => a.order - b.order).map((p: Project) => `<div class="entry"><span class="entry-title">${p.url && !p.githubUrl && !p.liveUrl ? `<a href="${escapeHtml(p.url)}" target="_blank" style="color:inherit;text-decoration:none">${escapeHtml(p.name)}</a>` : escapeHtml(p.name)}</span>${(p.githubUrl || p.liveUrl) ? `<span style="font-size: 0.9em; margin-left: 8px;">${p.githubUrl ? `<a href="${escapeHtml(p.githubUrl)}" target="_blank" style="color: #1e40af; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.githubUrl.replace(/^https?:\/\//, '')) : 'GitHub'}</a>` : ''}${p.githubUrl && p.liveUrl ? `<span style="color: #d1d5db; margin: 0 4px;">|</span>` : ''}${p.liveUrl ? `<a href="${escapeHtml(p.liveUrl)}" target="_blank" style="color: #1e40af; text-decoration: none;">${data.settings?.useFullUrls ? escapeHtml(p.liveUrl.replace(/^https?:\/\//, '')) : 'Live Demo'}</a>` : ''}</span>` : ''}${p.description ? `<p style="color:#4b5563;margin-top:4px">${formatDescription(p.description)}</p>` : ''}</div>`).join('')}</div>` : '';
      case 'certifications': return renderCertificationsHtml(data);
      default:
        if (typeof section === 'string' && section.startsWith('custom_')) return renderCustomSectionHtml(data, section);
        return '';
